...
**n/a** | **application/x-amiga-executable** | x-amiga-executable>root
...
**.aifc** | **audio/x-aifc** <br> audio/x-aiffc | aifc>root
**.au** | **audio/basic** | au>root
**.8svx** | **audio/x-8svx** <br> audio/8svx | 8svx>root
**.16sv** | **audio/x-16sv** | 16sv>root
**.maud** | **audio/x-maud** | maud>root
**.sid** | **audio/prs.sid** <br> audio/sid | sid>root
**.xm** | **audio/x-xm** | xm>root
**.s3m** | **audio/x-s3m** | s3m>root
**.mod** | **audio/x-mod** | mod>root
**.med** | **audio/x-med** | med>root
**.ahx** | **audio/x-ahx** | ahx>root
...
**.anim** | **video/x-anim** | anim>root
**.ilbm** | **image/x-ilbm** <br> image/ilbm | ilbm>root
**.kla** | **image/x-koala-painter** <br> image/x-koala | kla>root
...
**.lzh** | **application/x-lzh-compressed** <br> application/x-lha | lzh>root
**.adf** | **application/x-amiga-disk-format** | adf>root
**.dms** | **application/x-dms** | dms>root
**.bpg** | **image/bpg** | bpg>root
**.cbor** | **application/cbor** | cbor>root
**.msa** | **application/x-magic-shadow-archiver** | msa>root
**.st** | **application/x-atari-disk-image** | st>root
**.lzx** | **application/x-lzx** | lzx>root
