...
var files = map[string]string{
	...
	"csv.csv":                    "text/csv",
	"csv_one_line_not_match.txt": "text/plain; charset=utf-8",
	"csv_two_lines_match.csv":    "text/csv",
	...
	"tsv_one_line_not_match.txt": "text/plain; charset=utf-8",
	"tsv_two_lines_match.tsv":    "text/tab-separated-values",
