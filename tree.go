...
var (
	...
	text     = newMIME("text/plain", ".txt", magic.Text, html, svg, xml, php, js, lua, perl, python, json, ndJSON, rtf, vtt, srt, tcl, csv, tsv, vCard, iCalendar, warc)
	...
	srt      = newMIME("text/srt", ".srt", magic.Srt)
